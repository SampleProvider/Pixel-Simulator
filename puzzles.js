...
import { transitionIn, transitionOut, slideInPuzzles, showMenuTooltip, hideMenuTooltip, moveMenuTooltip } from "./menu.js";
...
let puzzles = {
    ...
    "lava_springs": {
        ...
        music: "square_waves",
        img: "data:image/png;base64,",
        official: true,
    },
    "breaking_gravity": {
        id: "breaking_gravity",
    ...
    "custom_objective_test": {
        id: "custom_objective_test",
        name: "Custom Objective Test",
        author: "sp",
        world: "fun stuff",
        saveCode: "V3;1;16-16;air-18:wall-4:air-3:wall:air-4:wall:air-2:wall-2:air-6:wall-2:air-3:wall:air-2:wall:air-7:wall:air:wall:air-2:wall:air-2:wall:air-2:wall-2:air-3:wall:air-2:wall:air:wall:air-2:wall-2:air-2:wall:air-3:wall:air-3:wall-2:air-3:wall-4:air-3:wall:air-4:wall:air-35:wall-4:air-4:wall-4:air-3:wall-2:air-2:wall-2:air-2:wall:air-4:wall:air-2:wall:air-4:wall:air-2:wall:air-7:wall:air-4:wall:air-3:wall-4:air-3:wall-2:air-2:wall-2:air-7:wall:air-3:wall-4:air-3:wall-5:air-18;0-256;0-256;",
        inventory: {
            air: 1000000,
            wall: 1000000,
            dirt: 1000000,
        ...
        objectives: [
            {
                type: "custom",
                run: "addObjective(\"great new objectives sp\", function() {if (grid[0] == 1) {return [1, 1, true]}return [0, 10000, false]});",
            },
        ],
        img: "data:image/png;base64,",
        official: true,
    },
};
let worlds = {
...
uploadCustomPuzzleButton.onclick = async function() {
    ...
    reader.onload = async (e) => {
        try {
            ...
            for (let i in json.objectives) {
                if (json.objectives[i].type == "custom") {
                    // if (!await modal("Custom Objective Exists", "You are loading a puzzle with a custom objective. Are you sure?", "confirm")) {
                    //     return;
                    // }
                    break;
                }
...
createCustomPuzzleAddObjectiveButton.onclick = function() {
    ...
    objective.children[1].oninput = () => {
        ...
        if (objective.children[1].value == "custom") {
            objective.children[4].style.display = "none";
            objective.children[5].style.display = "none";
            objective.children[6].style.display = "none";
            objective.children[7].style.display = "none";
            objective.children[8].style.display = "none";
            objective.children[9].style.display = "none";
            objective.children[10].style.display = "block";
            objective.children[11].style.display = "block";
        }
        else {
            objective.children[4].style.display = "block";
            objective.children[5].style.display = "block";
            objective.children[6].style.display = "block";
            objective.children[7].style.display = "block";
            objective.children[8].style.display = "block";
            objective.children[9].style.display = "block";
            objective.children[10].style.display = "none";
            objective.children[11].style.display = "none";
        }
    };
    objective.children[1].oninput();
    ...
    objective.children[10].setAttribute("for", "createCustomPuzzleObjectiveRun" + id);
    objective.children[11].id = "createCustomPuzzleObjectiveRun" + id;
    objective.children[11].onkeydown = (e) => {
        e.stopImmediatePropagation();
    };
    objective.children[12].onclick = () => {
        objective.remove();
...
createCustomPuzzleFinishButton.onclick = async function() {
    ...
    for (let i in pixels) {
        if (createCustomPuzzleInventoryListAmounts[i].value != 0) {
            puzzle.inventory[pixels[i].id] = Number(createCustomPuzzleInventoryListAmounts[i].value);
        }
    }
    for (let i in createCustomPuzzleObjectives) {
        ...
        if (createCustomPuzzleObjectives[i].children[1].value != "custom") {
            if (createCustomPuzzleObjectives[i].children[1].value == "destroyMonsters" && createCustomPuzzleObjectives[i].children[3].checked) {
            ...
            objective.run = createCustomPuzzleObjectives[i].children[11].value;
        }
        puzzle.objectives.push(objective);
    }
    try {
        let parsed = parseSaveCode(createCustomPuzzleSaveCode.value);
        puzzle.img = drawBlueprintImg(parsed.grid, parsed.gridWidth, parsed.gridHeight, parsed.gridWidth * 6, parsed.gridHeight * 6);
    }
    catch (err) {
        modal("Invalid Save Code", "Failed to parse puzzle save code.", "info");
        return;
    }
    if (puzzles[id] != null) {
...
function addPuzzle(id) {
    ...
    puzzle.onmouseover = function() {
        if (puzzleProgress[id] != null && puzzleProgress[id].completed) {
            showMenuTooltip(puzzles[id].name, puzzles[id].author + "<br>" + puzzleProgress[id].ticks + " ticks");
        }
        else {
            showMenuTooltip(puzzles[id].name, puzzles[id].author);
        }
        moveMenuTooltip();
    };
    ...
    for (let i in puzzles[currentPuzzle].objectives) {
        ...
        switch (objective.type) {
            ...
            case "custom":
                ...
                break;
            default:
                modal("Invalid objective", "Invalid objective type " + objective.type, "info");
                break;
        }
    }
    updateObjectives();
