...
if (device == null) {
    ...
    const imageBitmap = await createImageBitmap(await (await fetch("img/aprilFoolsPixels.png")).blob());
    ...
    let pixelTexture;
    const imageBitmap = await createImageBitmap(await (await fetch("img/aprilFoolsPixel-mipmaps.png")).blob());
