...
function pushLeftCheck(x, y, stronglyConnected) {
    ...
    for (x1 = x; x1 >= 0; x1--) {
        ...
        // if (canCollapse && id == COLLAPSABLE && x1 != x && collapsableXPos == -1) {
        ...
        if (pushPixels[y][x1] == null) {
            ...
            if (!canPushPistons && id == PISTON_RIGHT) {
                if (collapsableXPos != -1) {
                    break;
                }
                pushFail(x1);
...
function pushRightCheck(x, y, stronglyConnected) {
    ...
    for (x1 = x; x1 < gridWidth; x1++) {
        ...
        if (pushPixels[y][gridWidth - x1] == null) {
            ...
            if (!canPushPistons && id == PISTON_LEFT) {
                pushFail(x1);
                return false;
            }
        }
...
function pushUpCheck(x, y, stronglyConnected) {
    ...
    for (y1 = y; y1 >= 0; y1--) {
        ...
        if (pushPixels[y1][x] == null) {
            ...
            if (!canPushPistons && id == PISTON_DOWN) {
                pushFail(y1);
                return false;
            }
        }
